...
<head>
    ...
    <title>Registrasi Pengguna - Academic Information System Untag Surabaya</title>
...
<body class="text-center">
    ...
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation" novalidate action="services/registrasi-proses.php" method="post">
            <h3 class="fw-normal mb-3">Registrasi Pengguna</h2>
                ...
                <button class="w-100 rounded-5 btn btn-lg btn-primary mt-3 mb-2" name="daftar" value="abc" type="submit">Daftar</button>
