...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <div class="row">
            <div class="col">
                <a href="beranda-mahasiswa" class="btn btn-warning"><i class="fas fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
        <!-- Konten Artikel -->
        ...
        <div class="mt-8 border-t border-gray-300 pt-4">
            ...
            <form action="" method="POST" class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nama" name="nama" class="mt-1 p-2 w-full border-gray-300 rounded-md focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                </div>
                <div class="mb-4">
                    <label for="komentar" class="block text-sm font-medium text-gray-700">Komentar</label>
                    <textarea id="komentar" name="komentar" rows="3" class="mt-1 p-2 w-full border-gray-300 rounded-md focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required></textarea>
                </div>
                <div>
