...
<div class="container">
    <form class="well form-horizontal needs-validation" novalidate action="services/tambah-proses.php" method="post">
        <legend>Tambahkan Mahasiswa Baru :</legend>
        ...
        <div class="form-group">
            ...
            if (isset($_SESSION['notifikasi_tambah'])) {
                echo '<div>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ' . $_SESSION['notifikasi_tambah'] . '
                ...
                unset($_SESSION['notifikasi_tambah']);
            }
            $conn->close();
            ?>
            <!-- Baris 1 -->
        ...
        <div class="form-group mt-5 text-center">
            <button type="submit" name="mahasiswa_baru" class="btn btn-warning"><i class="bi bi-floppy mr-2"></i>Simpan<span class="glyphicon glyphicon-send"></span></button>
        </div>
    </form>
